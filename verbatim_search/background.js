...
function checkForValidUrl(details) {
  ...
  if (parsedURL.pathname.startsWith('/search') &&
    ...
    //don't add tbs if it's already there
    (!parsedURL.searchParams.has("tbs")))
  {
